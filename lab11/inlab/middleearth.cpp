...
/**
 @brief shuffle method shuffles the iterator values
 @author not me
 @date not today
 @return void
 @param first vector of strings iterator
 @param last vector of strings iterator
 @param g mt19937& reference???
 @todo nothing
 */
...
/**
 @brief const array of city names
 @author not me
 @date not today
 @todo nothing
 */
...
/**
 @brief middle earth method (of class middle earth)
 @author not me
 @date not today
 @param xsize an int
 @param ysize an int
 @param num_cities an int
 @param seed an int
...
/**
 @brief middle earth print method
 @author not me
 @date not today
 prints out the city names and the options to choose from
 @return void
 @todo nothing
 */
// The Mouth of Sauron!
...
/**
 @brief middle earth table print method
 prints out a table separated table of the distances, which can be loaded into excel
 @return void
 @todo nothing
 */
...
/**
 @brief middle earth get distance method
 @author not me
 @date not today
 method that calculates the distance between the two cities
 @return float
 @param city1 const string& reference
 @param city2 const string& reference
 @todo nothing
 */
...
/**
 @brief middle earth get itinerary method
 @author not me
 @date not today
 returns vector of strings for the best path (itinerary)
 @return vector of strings
 @param length an unsigned int
 @todo nothing
 */
