...
int main(){
    ...
    head = NULL;//(struct list_item*) malloc(sizeof(struct list_item));
    tail = NULL;//(struct list_item*) malloc(sizeof(struct list_item));
    temp = NULL;//(struct list_item*) malloc(sizeof(struct list_item));
